...
[Mods](/mod) and other [Project types](/projecttype) has greatly extended the already infinite possibilities of [Minecraft](/minecraft).
Today modding has become mush easier than the past but its still a hard thing to do because [Minecraft](/minecraft) is not designed to allow modifications apart from [Resource packs](/resourcepack) and [Datapacks](/datapack).
