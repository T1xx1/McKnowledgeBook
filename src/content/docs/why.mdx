...
I'm not a programming god, I'm just a web dev, and I still don't understand many things about the modding environment. If you find errors or problems, feel free to make changes by clicking the "Edit page" button at the end of every page, [contribute to the repo](https://github.com/t1xx1/mcknowledgebook) or contact me through my [Discord server](https://discord.gg/gaDqYhxyzB). I'm open to every suggestion.
