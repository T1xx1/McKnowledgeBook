...
I've also decided to create these docs in the first place for me, because I needed a place to archive all the information I was acquiring and also to describe some situations for my other project [Modpackker](https://modpackker.vercel.app), and it felt a waste of energy and time if I just kept everything for myself.
...
The Minecraft Wiki is the best place to look up information about [Minecraft](/minecraft), but only if we're talking about the [Vanilla](/vanilla) gameplay. It has some pages about modding, like for [mods](https://minecraft.wiki/mod), [datapacks](https://minecraft.wiki/data_pack) and [resource packs](https://minecraft.wiki/resource_pack), but no information about how modding actually works with [Loaders](/loader), [Launchers](/launcher), and the other [Project types](/projecttype), nor, which are the best [Tools](/tools) and best practices for modding.
