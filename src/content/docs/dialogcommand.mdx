...
:::note
`/dialog` and `/dialogue` are two different commands. [Dialogue • Minecraft Wiki](https://minecraft.wiki/w/Commands/dialogue)
:::
...
- [Minecraft Wiki](https://minecraft.wiki/w/Dialog)
